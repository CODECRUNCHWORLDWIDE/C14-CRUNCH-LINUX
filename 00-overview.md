...
- [week 01 shell and filesystem](./curriculum/week-01-shell-and-filesystem/00-overview.md)
- [week 02 text and pipes](./curriculum/week-02-text-and-pipes/00-overview.md)
- [week 03 permissions users groups](./curriculum/week-03-permissions-users-groups/00-overview.md)
- [week 04 shell scripting properly](./curriculum/week-04-shell-scripting-properly/00-overview.md)
- [week 05 systemd services](./curriculum/week-05-systemd-services/00-overview.md)
- [week 06 ssh networking firewalls](./curriculum/week-06-ssh-networking-firewalls/00-overview.md)
- [week 07 observability htop iostat strace](./curriculum/week-07-observability-htop-iostat-strace/00-overview.md)
- [week 08 disks filesystems and page cache](./curriculum/week-08-disks-filesystems-and-page-cache/00-overview.md)
