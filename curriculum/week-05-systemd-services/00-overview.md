...
| [resources.md](./01-resources.md) | systemd man pages, freedesktop.org documentation, books, and the references we cite |
| [lecture-notes/01-unit-files-services-timers-sockets.md](./02-lecture-notes/01-unit-files-services-timers-sockets.md) | Unit-file anatomy, `Type=`, `Restart=`, timers, sockets |
| [lecture-notes/02-journalctl-and-the-sandboxing-options.md](./02-lecture-notes/02-journalctl-and-the-sandboxing-options.md) | `journalctl` end-to-end, the eight sandboxing directives, `systemd-analyze` |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-first-unit-file.md](./03-exercises/exercise-01-first-unit-file.md) | Write your first `.service` unit, enable it, watch it restart |
| [exercises/exercise-02-timer-instead-of-cron.md](./03-exercises/exercise-02-timer-instead-of-cron.md) | Replace a `cron` job with a `.timer` + `.service` pair |
| [exercises/exercise-03-sandbox-a-service.md](./03-exercises/exercise-03-sandbox-a-service.md) | Take a wide-open service and ratchet `systemd-analyze security` from 9.6 toward 1.0 |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-multi-instance-template-units.md](./04-challenges/challenge-01-multi-instance-template-units.md) | One template unit (`worker@.service`), N instances, all parametric |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6 hours) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | A `systemd`-managed Python web app with restart policy, journald logging, and a non-trivial sandbox |
