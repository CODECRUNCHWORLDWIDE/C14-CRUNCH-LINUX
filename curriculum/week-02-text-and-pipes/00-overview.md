...
| [resources.md](./01-resources.md) | Books, papers, and reference cards |
| [lecture-notes/01-awk-as-a-language.md](./02-lecture-notes/01-awk-as-a-language.md) | `awk` from the ground up — patterns, actions, arrays |
| [lecture-notes/02-sed-and-text-surgery.md](./02-lecture-notes/02-sed-and-text-surgery.md) | `sed` substitutions, addresses, in-place editing |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-awk-puzzles.md](./03-exercises/exercise-01-awk-puzzles.md) | Ten `awk` puzzles, escalating in difficulty |
| [exercises/exercise-02-sed-substitutions.md](./03-exercises/exercise-02-sed-substitutions.md) | `sed` substitution drills |
| [exercises/exercise-03-real-log-pipeline.md](./03-exercises/exercise-03-real-log-pipeline.md) | Mixed `awk` + `sed` on `/var/log` |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-csv-without-python.md](./04-challenges/challenge-01-csv-without-python.md) | Parse a real CSV with `awk` alone |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6 hours) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Build a log-analysis pipeline answering five questions about `/var/log` |
