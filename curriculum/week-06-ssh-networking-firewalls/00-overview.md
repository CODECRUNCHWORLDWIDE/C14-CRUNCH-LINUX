...
| [resources.md](./01-resources.md) | OpenSSH man pages, nftables documentation, books, references |
| [lecture-notes/01-ssh-keys-agent-config-proxyjump.md](./02-lecture-notes/01-ssh-keys-agent-config-proxyjump.md) | Key generation, `ssh-agent`, `~/.ssh/config`, `sshd_config` hardening, ProxyJump |
| [lecture-notes/02-nftables-and-firewall-basics.md](./02-lecture-notes/02-nftables-and-firewall-basics.md) | TCP/IP refresher, nftables tables/chains/rules, the hardened-host template, `nmap` verification |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-key-auth-and-config.md](./03-exercises/exercise-01-key-auth-and-config.md) | Generate a key, distribute it, write a `~/.ssh/config` stanza, disable password auth |
| [exercises/exercise-02-proxyjump-bastion.md](./03-exercises/exercise-02-proxyjump-bastion.md) | Reach a private host through a bastion with one command |
| [exercises/exercise-03-nftables-rules.md](./03-exercises/exercise-03-nftables-rules.md) | Write an `nftables` ruleset for a hardened SSH+HTTP host, persist it, verify with `nmap` |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-harden-a-fresh-vps.md](./04-challenges/challenge-01-harden-a-fresh-vps.md) | End-to-end: provision a $5/mo VPS, harden it from "fresh image" to "production-shaped" in one sitting |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6 hours) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Provision a $5/mo VPS, harden SSH, configure firewall, verify with nmap |
