...
When done, push. You've completed Week 3's exercises. On to the [challenge](../04-challenges/challenge-01-multi-user-shared-folder.md) and the [mini-project](../07-mini-project/00-overview.md).
