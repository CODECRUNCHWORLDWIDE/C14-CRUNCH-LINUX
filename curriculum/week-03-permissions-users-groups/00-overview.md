...
| [resources.md](./01-resources.md) | Manuals, books, and the GNU coreutils citations |
| [lecture-notes/01-the-unix-permission-bits.md](./02-lecture-notes/01-the-unix-permission-bits.md) | The nine bits, `umask`, special bits, `chmod`/`chown` |
| [lecture-notes/02-users-groups-sudo-acls.md](./02-lecture-notes/02-users-groups-sudo-acls.md) | Account databases, group management, `sudo`, ACLs |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-permission-puzzles.md](./03-exercises/exercise-01-permission-puzzles.md) | Twelve permission puzzles — read, convert, predict |
| [exercises/exercise-02-add-users-and-groups.md](./03-exercises/exercise-02-add-users-and-groups.md) | Hands-on user/group lifecycle on a throwaway VM |
| [exercises/exercise-03-setuid-investigation.md](./03-exercises/exercise-03-setuid-investigation.md) | Audit `setuid` binaries on a real system; explain each |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-multi-user-shared-folder.md](./04-challenges/challenge-01-multi-user-shared-folder.md) | Build a `setgid` shared folder where three users collaborate |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6 hours) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Configure a multi-user demo with appropriate permission boundaries |
