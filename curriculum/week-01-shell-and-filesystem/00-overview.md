...
| [resources.md](./01-resources.md) | Curated free readings + cheat-sheets |
| [lecture-notes/01-what-is-linux-and-what-is-a-shell.md](./02-lecture-notes/01-what-is-linux-and-what-is-a-shell.md) | The kernel/distro/shell stack, demystified |
| [lecture-notes/02-the-filesystem-hierarchy.md](./02-lecture-notes/02-the-filesystem-hierarchy.md) | Every top-level directory, what's in it, why |
| [lecture-notes/03-pipes-redirection-globs.md](./02-lecture-notes/03-pipes-redirection-globs.md) | Streams, pipelines, expansion |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-fifty-commands.md](./03-exercises/exercise-01-fifty-commands.md) | Run all 50 commands in the cheat-sheet at least once |
| [exercises/exercise-02-find-the-files.md](./03-exercises/exercise-02-find-the-files.md) | `find` puzzles |
| [exercises/exercise-03-grep-and-pipes.md](./03-exercises/exercise-03-grep-and-pipes.md) | `grep` + pipes on a real log |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-recover-from-disaster.md](./04-challenges/challenge-01-recover-from-disaster.md) | Recover a "broken" machine without reinstalling |
| [challenges/challenge-02-build-your-own-tree.md](./04-challenges/challenge-02-build-your-own-tree.md) | Reimplement `tree` as a shell script |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Filesystem map mini-project |
