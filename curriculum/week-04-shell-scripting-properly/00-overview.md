...
| [resources.md](./01-resources.md) | BashGuide, BashPitfalls, ShellCheck, and the references we cite |
| [lecture-notes/01-set-euo-pipefail-and-quoting.md](./02-lecture-notes/01-set-euo-pipefail-and-quoting.md) | The three-flag opener, quoting, `[[ ]]`, ShellCheck |
| [lecture-notes/02-functions-and-trap-signals.md](./02-lecture-notes/02-functions-and-trap-signals.md) | Functions, traps, cleanup patterns, `mktemp`, `flock` |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-write-3-defensive-scripts.md](./03-exercises/exercise-01-write-3-defensive-scripts.md) | Three small scripts, each one a defensive-coding drill |
| [exercises/exercise-02-trap-and-cleanup.md](./03-exercises/exercise-02-trap-and-cleanup.md) | Build a script with a trap-driven cleanup, then try to break it |
| [exercises/exercise-03-shellcheck-fixes.md](./03-exercises/exercise-03-shellcheck-fixes.md) | A deliberately broken script — fix every ShellCheck warning |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-rewrite-bad-script.md](./04-challenges/challenge-01-rewrite-bad-script.md) | A real-world "bad backup script" — rewrite it properly |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems (~6 hours) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Three useful scripts: backup wrapper, log rotator, disk-usage reporter |
